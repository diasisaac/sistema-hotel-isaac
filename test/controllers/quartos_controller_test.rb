...
class QuartosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quarto" do
    assert_difference("Quarto.count") do
      post quartos_url, params: { quarto: { andar: @quarto.andar, capacidade: @quarto.capacidade, descricao: @quarto.descricao, diaria: @quarto.diaria, nome: @quarto.nome } }
    end
  ...
  test "should update quarto" do
    patch quarto_url(@quarto), params: { quarto: { andar: @quarto.andar, capacidade: @quarto.capacidade, descricao: @quarto.descricao, diaria: @quarto.diaria, nome: @quarto.nome } }
