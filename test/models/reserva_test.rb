...
class ReservaTest < ActiveSupport::TestCase
  ...
  test 'deveria salvar reserva com atributos validos' do
    ...
    reserva = Reserva.new(check_in:"2022-04-20", checkout: "2022-04-28", cliente_id: cliente.id, quarto_id: quarto.id, numero_adultos: 2, numero_criancas: 0, pedidos:"cucuz com ovo e café")
  ...
  test 'nao deveria salvar reserva sem cliente' do
    ...
    reserva = Reserva.new(check_in:"2022-04-20" , checkout: "2022-04-28", cliente_id: nil, quarto_id: quarto.id, numero_adultos: 2, numero_criancas: 0, pedidos:"cucuz com ovo e café")
